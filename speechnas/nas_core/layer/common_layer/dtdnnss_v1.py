...
from speechnas.nas_core.global_enum import Activation, Padding
from speechnas.nas_core.layer.common_layer.batchnorm1d import BatchNorm1d_
from speechnas.nas_core.layer.common_layer.conv1d import Conv1d_
from speechnas.nas_core.layer.common_layer.linear import Linear_
from speechnas.nas_core.layer.utils import _act
...
class StatsSelect(nn.Module):
    ...
    def __init__(self, in_out_channels, reduction_channels, num_branches, is_folded=False):
        ...
        self.linear1 = Linear_(in_features=in_out_channels * 4,
                               out_features=reduction_channels,
                               bias=True,
                               act=Activation.Identity,
                               is_folded=self.is_folded)
        self.linear2 = nn.ModuleList()
        for _ in range(num_branches):
            self.linear2.append(Linear_(in_features=reduction_channels,
